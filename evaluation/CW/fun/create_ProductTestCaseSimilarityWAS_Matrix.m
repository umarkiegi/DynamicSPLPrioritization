function create_ProductTestCaseSimilarityWAS_Matrix(paths,Wp,Wtc,version)
...
% based on the weighted all signals distances
    ...
    % save
    ProductTestCaseSimilarityWASPath = strcat(paths.stage,'\ProductTestCaseSimilarityWAS_',version,'.mat');
