function create_ProductTestCaseSimilarityWCS_Matrix(paths,Wp,Wtc,version)
...
% CONTAINED = shared signals between two products
    ...
    signalDistancesPath = strcat(paths.in,'\signalDistances_',version,'.mat');
    ...
    % save
    ProductTestCaseSimilarityWCSPath = strcat(paths.stage,'\ProductTestCaseSimilarityWCS_',version,'.mat');
