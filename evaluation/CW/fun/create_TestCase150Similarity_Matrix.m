function create_TestCase150Similarity_Matrix(paths,version)
...
% signals of the test cases
    ...
    % Load data
    signalDistancePath = strcat(paths.in,'\signalDistances_',version,'.mat');
    ...
    % save
    TestCase150SimilarityPath = strcat(paths.stage,'\TestCase150Similarity_',version,'.mat');
    save(TestCase150SimilarityPath,'TestCase150Similarity');
    % save excel
    TestCase150SimilarityExcelPath = strcat(paths.stage,'\TestCase150Similarity_',version,'.xlsx');
