...
nProducts = 17;
nTC150 = 150;
type = 'WAS';    % WAS, WCS, label for output file naming
version = 'v1';
%%%
...
%prioritizationArrayFilename = strcat('prioritizationArray',type);
...
resultsPath = strcat(paths.out,'\results',type,'.mat');
save(resultsPath,'results');
% save Excel
resultsExcelPath = strcat(paths.out,'\results',type,'.xlsx');
